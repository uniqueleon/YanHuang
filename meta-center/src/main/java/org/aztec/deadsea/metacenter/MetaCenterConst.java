...
public interface MetaCenterConst {
	...
	public interface ZkConfigPaths{
		...
		public static String DATABASE_INFO = BASE_AUTHENTICATIONS_INFO + ".%s";
		public static String TABLES_SHARDING_INFO = DATABASE_INFO + ".%s";
		public static String SHARDING_AGE_INFO = TABLES_SHARDING_INFO + ".%s";
	}
